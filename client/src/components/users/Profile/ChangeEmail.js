                        ...
                        <Col sm={6} smOffset={3}>
                            <div className="panel panel-login">
                                <div className="panel-heading">
                                    <Row>
                                        <Link
                                            className='login-header' to='/users/profile/changeemail'
                                        >
                                            <Col>
                                                Change your email
                                            </Col>
                                ...
                                <Row className="panel-body">
                                    <Col lg={12}>
                                        <form className='change-email-form' onSubmit={handleSubmit(this.submit.bind(this))}>
                                            <Field
                                                id='change-email-form-email'
                                                placeholder='New email address' name='newEmail'
                                                glyph='envelope' component={RenderInput}
                                            />
                                            <Field
                                                id='change-email-form-password'                                            
                                                type='password' placeholder='Password'
                                                glyph='lock' name='password' component={RenderInput}
                                            />
